...
@Service
public class ProgramacionServiceImpl implements IClienteService {
	...
	@Override
	@Transactional
	public List<Cliente> buscarNombre(String nameCliente) {
		return dCliente.buscarNombre(nameCliente);
	}
